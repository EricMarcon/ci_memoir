...
date: "`r Sys.Date()`"
url: https://EricMarcon.github.io/ci_memoir/
github-repo: EricMarcon/ci_memoir
...
# pak to manage packages
if (!"pak" %in% installed.packages()[, 1]) {
  install.packages("pak", repos="https://cran.rstudio.com/")
}

# Basic packages
pak::pkg_install(c("bookdown", "formatR", "kableExtra", "magick", "ragg"))
